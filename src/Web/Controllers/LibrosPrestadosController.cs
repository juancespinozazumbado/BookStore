...
{
    public class LibrosPrestadosController : Controller
    {

        RepositorioDeLibros _RepositorioDeLibros;

        public LibrosPrestadosController(IMemoryCache cache)
        {
            _RepositorioDeLibros = new RepositorioDeLibros(cache);
        }
        // GET: LibrosPrestadosController
        public ActionResult Index(string nombre)
        {
            if (nombre is null)
            {
                List<Libro> librosPrestados = _RepositorioDeLibros.ObtenerLibrosPrestados();
        ...
        // GET: LibrosPrestadosController/Details/5
        ...
        // GET: LibrosPrestadosController/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: LibrosPrestadosController/Create
        [HttpPost]
        ...
        // GET: LibrosPrestadosController/Edit/5
        public ActionResult Edit(int id)
        {
            ...
            libroAEditar.Tipo = (Web.Models.TipoDeLibro)(TipoDeLibro)libro.Tipo;
